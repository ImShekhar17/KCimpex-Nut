  ...
  const materialCategories = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'SS 321', link: '/materials/ss-321', active: true },
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-6 border-b-2 border-gray-200 pb-4">
                Stainless Steel 321 Fasteners Manufacturer, Supplier of Stainless Steel 321 Bolts, Exporter of Stainless Steel 321 Nuts and Bolts, Leading Stainless Steel 321 Fasteners Manufacturers in India
              </h2>
              <div className="prose max-w-none text-gray-700 leading-relaxed space-y-4 mb-8">
                <p>
                  Stainless steel 321 fasteners stand as the top preference across industries due to their exceptional durability and strength. Renowned for their corrosion resistance and high-temperature performance, they excel in environments subjected to extreme climates or frequent exposure to corrosive substances like water. SS 321H Fasteners boast energy-efficient aircraft parts and exhaust systems to gas turbines and medical instruments, showcasing their reliability and adaptability across diverse sectors.
                </p>
                <p>
                  Stainless Steel Fasteners boast a diverse array of types, including bolts, nuts, screws, washers, and rods, each offering distinct advantages tailored to specific applications. Bolts ensure a secure connection between components, while washers provide additional support and stability when paired with bolts or nuts. SS 321 Fasteners come in various forms such as Stainless Steel 321 Washers and Stainless Steel 321H Stud Bolts, catering to a multitude of needs. Notably, Fasteners are particularly suited for applications demanding precise fits, whereas nut-demanding precise fits, whereas nuts are suited to achieve structural joints requiring uniformity and robustness.
                </p>
              </div>
              ...
              <p className="text-gray-700 mb-4">Note that this chart includes only some of the most common sizes of SS 321 Bolt. There are many other sizes available as well, and some applications may require custom sizes or special configurations.</p>
              <div className="overflow-x-auto mb-8">
                <table className="min-w-full border border-gray-300">
                  <thead>
                    <tr className="bg-blue-900 text-white">
                      <th className="px-4 py-3 text-left font-semibold border-r border-gray-300">SS 321 Elements</th>
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4 mt-8 border-b border-gray-300 pb-2">
                Types of SS 321 Fasteners
              </h3>
              <p className="text-gray-700 mb-6">Each SS 321 Fasteners have unique design each of them are used in specific applications. Some of them are mentioned below.</p>

              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="border border-gray-200 rounded-lg overflow-hidden">
                  <div className="aspect-square bg-gray-100 flex items-center justify-center">
                    <img src="https://images.pexels.com/photos/209235/pexels-photo-209235.jpeg?auto=compress&cs=tinysrgb&w=400" alt="SS 321 Nuts" className="w-full h-full object-cover" />
                  </div>
                  <div className="p-4">
                ...
                <div className="border border-gray-200 rounded-lg overflow-hidden">
                  <div className="aspect-square bg-gray-100 flex items-center justify-center">
                    <img src="https://images.pexels.com/photos/209235/pexels-photo-209235.jpeg?auto=compress&cs=tinysrgb&w=400" alt="SS 321 Bolts" className="w-full h-full object-cover" />
                  </div>
                  <div className="p-4">
                ...
                <div className="border border-gray-200 rounded-lg overflow-hidden">
                  <div className="aspect-square bg-gray-100 flex items-center justify-center">
                    <img src="https://images.pexels.com/photos/209235/pexels-photo-209235.jpeg?auto=compress&cs=tinysrgb&w=400" alt="SS 321 Washers" className="w-full h-full object-cover" />
                  </div>
                  <div className="p-4">
