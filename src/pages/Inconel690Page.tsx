...
const Inconel690Page = () => {
  ...
  const chemicalComposition = [
    { element: 'Carbon, C', content: '0.05% max' },
    { element: 'Chromium, Cr', content: '27-31% (30%)' },
    { element: 'Copper, Cu', content: '0.5% max' },
    { element: 'Iron, Fe', content: '7-11% (10%)' },
    { element: 'Manganese, Mn', content: '0.5% max' },
    { element: 'Nickel, Ni', content: '58-63% min' },
    { element: 'Sulfur, S', content: '0.01% max' },
    { element: 'Silicon, Si', content: '0.5% max' }
  ];

  const mechanicalProperties = [
    { property: 'Density', value: '8.19 g/cm3' },
    { property: 'Melting Point', value: '1345 °C (2460 °F)' },
    { property: 'Tensile Strength', value: '721 MPa, 105000 psi' },
    { property: 'Yield Strength (0.2%Offset)', value: '334 MPa, 50300 psi' },
    { property: 'Elongation', value: '41 %' }
  ];
  ...
  const materialCategories = [
    {
      ...
      items: [
        ...
        { name: 'INCONEL alloy 690', link: '/materials/inconel-alloy-690', active: true },
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                Inconel Fasteners Manufacturer, Supplier of Inconel Alloy 690 Bolts, Exporter of Inconel Alloy 690 Nuts and Bolts, Leading Inconel Alloy 690 Fasteners Manufacturers in India
              </h2>
              <div className="space-y-4 text-gray-700 leading-relaxed">
                <p>
                  <span className="text-[#1e3a8a] font-semibold">Inconel Alloy 690 Fasteners</span> represent a nickel-based superalloy containing approximately 29% nickel, 17% chromium, and varying proportions of iron, aluminum, titanium, molybdenum, cobalt, copper, and manganese. Engineered to exhibit exceptional resistance to corrosion and oxidation, these fasteners are tailored for deployment in the most demanding environments. Notably, <span className="text-[#1e3a8a] font-semibold">Inconel Alloy 690 fasteners</span> boast a remarkable tensile strength exceeding 200 ksi (1400 MPa), enabling them to withstand the rigors of high-temperature stress without succumbing to structural failure. Further, Inconel Alloy 690 fasteners possess a high melting point that outpaces the capabilities of most other alloys available in the market. Equipped with excellent non-magnetic properties, they prove their worth in scenarios where magnetism may lead to undesirable outcomes. Additionally, their non-magnetic nature diminishes the risk of magnetic interference with nearby electrical equipment or devices, provided they are installed correctly.
                </p>
                <p>
                  <span className="text-[#1e3a8a] font-semibold">WNR 2.4669 Fasteners</span> present numerous distinct advantages over alternative fastener types. Firstly, their exceptional corrosion-to-weight ratio ensures robust performance under heavy loads while maintaining a lightweight profile, avoiding undue weight on the base structure. Additionally, their non-magnetic nature eliminates the risk of magnetic interference with nearby electrical equipment or devices, provided correct installation. Finally, their versatility and reliability across diverse industrial settings, underscoring their versatility and reliability. Further, Inconel Alloy 690 fasteners can safeguard product longevity through prevention of corrosion or rust, thereby reducing the need for frequent maintenance or upkeep over time. Additionally, they can endure high-temperature scenarios without succumbing to failure or breakdowns, thereby reducing costly repairs that stem from untimely failures. Moreover, Inconel Alloy 690 fasteners can uplift their operational integrity over time by thwarting corrosion or rust, thereby reducing the need for frequent maintenance or upkeep. Their compatibility across a multitude of applications, ranging from components undergoing cyclic loading conditions to those subjected to intense heat sources, further underscores their versatility and reliability.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                Specifications of INCONEL Alloy 690
              </h2>
              <p className="text-gray-700 mb-6">
                Standard INCONEL Alloy 690 Fasteners specifications as per Fasteners manufacturers.
              </p>
              <table className="w-full border border-gray-300">
                <tbody>
                  <tr className="border-b border-gray-300">
                    <td className="px-6 py-3 bg-gray-50 font-semibold text-gray-900">Material</td>
                    <td className="px-6 py-3 text-gray-700">Inconel Alloy 690</td>
                  </tr>
                  <tr className="border-b border-gray-300">
            ...
            <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                Types of INCONEL Alloy 690 Fasteners
              </h2>
              <p className="text-gray-700 mb-8">
                Each <span className="text-[#1e3a8a] font-semibold">INCONEL Alloy 690</span> Fasteners have unique design each of them are used in specific applications. Some of them are mentioned below.
              </p>
            ...
            <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                INCONEL Alloy 690 Chemical Composition
              </h2>
              <p className="text-gray-700 mb-6">
                Note that this chart includes only some of the most common sizes of <span className="text-[#1e3a8a] font-semibold">INCONEL Alloy 690 Bolt</span>. There are many other sizes available as well, and some applications may require custom sizes or special configurations.
              </p>
              <div className="overflow-x-auto">
                <table className="w-full border border-gray-300">
                  <thead>
                    <tr className="bg-[#1e3a8a] text-white">
                      <th className="px-6 py-3 text-left font-semibold">INCONEL Alloy 690 Fasteners</th>
            ...
            <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                INCONEL Alloy 690 Mechanical Properties
              </h2>
              <div className="overflow-x-auto">
                <table className="w-full border border-gray-300">
                  <tbody>
            ...
            <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-8">
                Applications Of INCONEL Alloy 690
              </h2>
