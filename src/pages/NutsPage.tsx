    ...
    <div className="min-h-screen flex flex-col">
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <h1 className="text-5xl font-bold text-white mb-4">NUT</h1>
          <div className="flex items-center gap-2 text-white text-lg">
            <Link to="/" className="hover:underline">Home</Link>
            <span>→</span>
            <span className="font-semibold">Nuts</span>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            <div className="lg:col-span-3">
                    ...
                    <table className="w-full">
                      <tbody className="divide-y divide-gray-300">
                        <tr>
                          ...
                          <td className="px-4 py-3 text-gray-700">M3 - M56 | 3/6" to 2" | Custom Sites</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-3 bg-gray-50 font-semibold text-gray-800 border-r border-gray-300">Nut Length</td>
                          <td className="px-4 py-3 text-gray-700">3 mm to 200 mm</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-3 bg-gray-50 font-semibold text-gray-800 border-r border-gray-300">Nut</td>
                          <td className="px-4 py-3 text-gray-700">UNF, BSW, BSF, METRIC, UNC, or as required</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td className="px-4 py-3 bg-gray-50 font-semibold text-gray-800 border-r border-gray-300">Dimensions</td>
                          <td className="px-4 py-3 text-gray-700">DIN 931, 933, 934, 7991, 976, 125, ASME B18.2.1, B18.3</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-3 bg-gray-50 font-semibold text-gray-800 border-r border-gray-300">THREAD TYPE</td>
                          <td className="px-4 py-3 text-gray-700">Unless otherwise specified, the threads shall be rolled or cut and tapped horizontally or vertically</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-3 bg-gray-50 font-semibold text-gray-800 border-r border-gray-300">Form of Nut</td>
              ...
              <div className="mb-12">
                <h3 className="text-3xl font-bold text-gray-800 mb-2">Types of Nut</h3>
                <div className="w-16 h-1 bg-[#1e3a8a] mb-6"></div>
                <p className="text-gray-600 text-lg leading-relaxed mb-8">
                  Each nut boasts a unique design tailored for specific applications, ensuring optimal performance and reliability. For instance
                </p>

                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                  {nutTypes.map((nut, idx) => (
                    <div key={idx} className="group cursor-pointer">
                      <div className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all duration-300">
                        ...
                        <div className="p-4 text-center">
                          <h4 className="text-[#1e3a8a] font-semibold text-lg">{nut.name}</h4>
                        </div>
                      </div>
                    </div>
                  ))}
              ...
              <div className="mb-12">
                <h3 className="text-3xl font-bold text-gray-800 mb-2">Applications Of Nut</h3>
                <div className="w-16 h-1 bg-[#1e3a8a] mb-6"></div>
                ...
                <div className="p-4">
                  <div className="space-y-2 mb-6">
                    ...
                    <div className="block px-4 py-3 bg-gray-50 border-l-4 border-[#2563eb] flex items-center justify-between">
                      <span className="font-medium text-gray-800">Nuts</span>
