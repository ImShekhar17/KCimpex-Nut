...
<div className="relative py-32 overflow-hidden">
  ...
  <div className="container mx-auto px-4 relative z-10">
    <h1 className="text-5xl font-bold text-white mb-4">STUDS</h1>
    <div className="flex items-center gap-2 text-white text-lg">
      <Link to="/" className="hover:underline">Home</Link>
      <span>→</span>
      <span className="font-semibold">Studs</span>
    </div>
  </div>
</div>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            <div className="lg:col-span-3">
              ...
              <div className="mb-12">
                <h3 className="text-3xl font-bold text-gray-800 mb-2">Types of Studs</h3>
                <div className="w-16 h-1 bg-[#1e3a8a] mb-6"></div>
                <p className="text-gray-600 text-lg leading-relaxed mb-8">
                  Ensure you select the appropriate Studs for your application, considering factors such as material, size, and load-bearing capacity, as each Studs boasts a unique design tailored for specific purposes. Below are some examples:
                </p>

                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                  {studTypes.map((stud, idx) => (
                    <div key={idx} className="group cursor-pointer">
                      <div className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all duration-300">
                        ...
                        <div className="p-4 text-center">
                          <h4 className="text-[#1e3a8a] font-semibold text-lg">{stud.name}</h4>
                        </div>
                      </div>
                    </div>
                  ))}
              ...
              <div className="mb-12">
                <h3 className="text-3xl font-bold text-gray-800 mb-2">Applications Of Studs</h3>
                <div className="w-16 h-1 bg-[#1e3a8a] mb-6"></div>
                ...
                <div className="p-4">
                  <div className="space-y-2 mb-6">
                    ...
                    <div className="block px-4 py-3 bg-gray-50 border-l-4 border-[#2563eb] flex items-center justify-between">
                      <span className="font-medium text-gray-800">Studs</span>
