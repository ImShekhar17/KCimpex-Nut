  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div
        ...
        style={{
          backgroundImage: 'url(https://images.pexels.com/photos/1216589/pexels-photo-1216589.jpeg?auto=compress&cs=tinysrgb&w=1260)',
        }}
      >
        <div className="absolute inset-0 bg-[#1e3a8a] bg-opacity-80"></div>
        <div className="container mx-auto px-4 relative z-10">
          <h1 className="text-5xl font-bold text-white mb-4">WASHER</h1>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            <div className="lg:col-span-3">
              <div className="mb-12">
                ...
                <div className="space-y-4">
                  <p className="text-gray-700 leading-relaxed">
                    As a leading <span className="text-[#2563eb] font-semibold">Washer Manufacturer in India</span>, we prioritize delivering premium-quality products at competitive prices. Our range includes a variety of washers, such as <span className="text-[#2563eb]">Flat, Lock, Star, Spring, Square,</span> and <span className="text-[#2563eb]">Plain Washers</span>, manufactured in diverse dimensions, grades, and types.
                  </p>
                  <p className="text-gray-700 leading-relaxed">
                    We excel in handling custom orders, leveraging our expertise to meet unique requirements and ensuring utmost client satisfaction. With a strong focus on quality, we've earned the trust of customers, positioning ourselves as one of the most reliable <span className="font-semibold">Washer suppliers in Mumbai</span>.
                  </p>
                  <p className="text-gray-700 leading-relaxed">
                    Our commitment to customer satisfaction and timely delivery has earned us a strong reputation in the industry. We continuously strive to uphold our standards of excellence, cementing our position as a trusted partner for all washer needs.
                  </p>
                </div>
              </div>
                    ...
                    <table className="w-full">
                      <tbody className="divide-y divide-gray-300">
                        ...
                        <tr>
                          ...
                          <td className="px-4 py-3 text-gray-700">M02 to M33, Custom Sizes</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-3 bg-gray-50 font-semibold text-gray-800 border-r border-gray-300">Form of Washer</td>
                          <td className="px-4 py-3 text-gray-700">Hex, Threading, Square, Round as per Gauge Etc.</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-3 bg-gray-50 font-semibold text-gray-800 border-r border-gray-300">Type Of Washer</td>
                          <td className="px-4 py-3 text-gray-700">Machine Washers, Flat Washer, Star Washers, Sealing Washer, Lock Washer, Split Washer etc.</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-3 bg-gray-50 font-semibold text-gray-800 border-r border-gray-300">STANDARD FOLLOWED</td>
                          <td className="px-4 py-3 text-gray-700">DIN 125A, DIN 125B, DIN 127B, DIN 137B, DIN 6797A, DIN 6797J, ISO 7089, DIN 7980, DIN 127 B, IS 2016, ASTM F436M, ASME B18.13, ASME B18.21.1, ASME B18.22.1, ASME B18.23.1</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                    ...
                    <div key={idx} className="group cursor-pointer">
                      <div className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all duration-300">
                        ...
                        <div className="p-4 text-center">
                          <h4 className="text-[#1e3a8a] font-semibold text-lg">{washer.name}</h4>
                        </div>
                      </div>
                    </div>
                  ))}
              ...
              <div className="mb-12">
                <h3 className="text-3xl font-bold text-gray-800 mb-2">Applications Of Washer</h3>
                <div className="w-16 h-1 bg-[#1e3a8a] mb-6"></div>
                ...
                <div className="p-4">
                  <div className="space-y-2 mb-6">
                    ...
                    <div className="block px-4 py-3 bg-gray-50 border-l-4 border-[#2563eb] flex items-center justify-between">
                      <span className="font-medium text-gray-800">Washers</span>
