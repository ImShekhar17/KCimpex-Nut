...
const SS309Page = () => {
  ...
  const chemicalComposition = [
    { element: 'Chromium (Cr)', content: '22-24%' },
    { element: 'Nickel (Ni)', content: '12-15%' },
    { element: 'Iron (Fe)', content: 'Balance' },
    { element: 'Manganese (Mn)', content: '2%' },
    { element: 'Silicon (Si)', content: '1%' },
    { element: 'Carbon (C)', content: '0.2% max' },
    { element: 'Phosphorus (P)', content: '0.045% max' },
    { element: 'Sulfur (S)', content: '0.03% max' }
  ];

  const mechanicalProperties = [
    { property: 'Density', value: '8.8 g/cm3' },
    { property: 'Melting Point', value: '1350 °C (2460 °F)' },
    { property: 'Tensile Strength', value: '75 ksi (515 MPa) minimum' },
    { property: 'Yield Strength (0.2%Offset)', value: '30 ksi (205 MPa) minimum' },
    { property: 'Elongation', value: '40% minimum' }
  ];
  ...
  const materialCategories = [
    ...
    },
    {
      ...
      items: [
        { name: 'SS 309', link: '/materials/ss-309', active: true },
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                SS 309 Fasteners Manufacturer, Supplier of SS 309 Bolts, Exporter of SS 309 Nuts and Bolts, Leading SS 309 Fasteners Manufacturers in India
              </h2>
              <div className="space-y-4 text-gray-700 leading-relaxed">
                <p>
                  Fasteners are indispensable components across various products, spanning automobiles, appliances, medical devices, and electronics. Among the multitude of materials available for fasteners, <span className="text-[#1e3a8a] font-semibold">Stainless Steel 309 Fasteners</span> stand out as a popular choice. Renowned for their exceptional corrosion resistance, SS 309 Fasteners offer superior performance compared to other metals and alloys. Composed primarily of iron alloyed with chromium (22-24%), nickel (12-15%), and chrome, <span className="text-[#1e3a8a] font-semibold">Stainless Steel 309 Fasteners</span>, also referred to as SS309, boast remarkable physical properties, including strength and durability. Additionally, variants such as 309L Stainless Steel Fasteners, featuring low carbon content for enhanced corrosion resistance, are preferred for applications requiring welding. Conversely, <span className="text-[#1e3a8a] font-semibold">SS 309H Fasteners</span> represent a high-carbon version tailored for applications demanding elevated-temperature strength.
                </p>
                <p>
                  <span className="text-[#1e3a8a] font-semibold">UNS S30900 Fasteners</span>, renowned for their commendable corrosion resistance, particularly excel in saltwater environments, making them a preferred choice for marine applications where consistent maintenance may not be feasible. Their versatility extends to various industries, including automotive manufacturing, construction projects, food processing equipment, home fixtures, kitchen appliances, and electronic devices. <span className="text-[#1e3a8a] font-semibold">SS UNS S30900 Fasteners</span> are favored for outdoor projects such as railings or fences, owing to their exceptional corrosion resistance against harsh weather conditions. Moreover, <span className="text-[#1e3a8a] font-semibold">UNS S30900 Fasteners</span> find application in food processing equipment owing to their non-reactive nature. A wide range of SS Fasteners are available, including options like <span className="text-[#1e3a8a] font-semibold">Stainless Steel 347 Fasteners</span>, <span className="text-[#1e3a8a] font-semibold">Stainless Steel 316H Fasteners</span>, and more, catering to diverse industrial needs.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                Specifications of SS 309
              </h2>
              <p className="text-gray-700 mb-6">
                Standard SS 309 Fasteners specifications as per Fasteners manufacturers.
              </p>
              <table className="w-full border border-gray-300">
                <tbody>
                  <tr className="border-b border-gray-300">
                    <td className="px-6 py-3 bg-gray-50 font-semibold text-gray-900">Material</td>
                    <td className="px-6 py-3 text-gray-700">SS 309</td>
                  </tr>
                  <tr className="border-b border-gray-300">
                  ...
                  <tr className="border-b border-gray-300">
                    ...
                    <td className="px-6 py-3 text-gray-700">ASTM / ASME - A/ SA 193 / 193</td>
                  </tr>
                  <tr className="border-b border-gray-300">
                  ...
                  <tr>
                    ...
                    <td className="px-6 py-3 text-gray-700">M02 to M30</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                Types of SS 309 Fasteners
              </h2>
              <p className="text-gray-700 mb-8">
                Each <span className="text-[#1e3a8a] font-semibold">SS 309 Fasteners</span> have unique design each of them are used in specific applications. Some of them are mentioned below.
              </p>
            ...
            <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                SS 309 Chemical Composition
              </h2>
              <p className="text-gray-700 mb-6">
                Note that this chart includes only some of the most common sizes of <span className="text-[#1e3a8a] font-semibold">SS 309 Bolt</span>. There are many other sizes available as well, and some applications may require custom sizes or special configurations.
              </p>
              <div className="overflow-x-auto">
                <table className="w-full border border-gray-300">
                  <thead>
                    <tr className="bg-[#1e3a8a] text-white">
                      <th className="px-6 py-3 text-left font-semibold">SS 309 Fasteners</th>
