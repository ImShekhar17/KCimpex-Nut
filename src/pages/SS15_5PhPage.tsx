  ...
  const materialCategories = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'SS 15-5Ph', link: '/materials/ss-15-5ph', active: true },
      ],
    },
    {
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-6 border-b-2 border-gray-200 pb-4">
                Stainless Steel 15-5 PH Fasteners Manufacturer, Supplier of Stainless Steel 15-5 PH Bolts, Exporter of Stainless Steel 15-5 PH Nuts and Bolts, Leading Stainless Steel 15-5 PH Fasteners Manufacturers in India
              </h2>
              <div className="prose max-w-none text-gray-700 leading-relaxed space-y-4 mb-8">
                <p>
                  Stainless Steel 15-5 PH Fasteners embody a martensitic grade stainless steel renowned for its resilience and durability. The alloy composition of SS 15-5 PH Fasteners features a significant proportion of chromium, nickel, and copper. This martensitic stainless steel grade derives its strength from the precipitation of these core elements, further augmented by the addition of trace amounts of other elements. The SS 15-5 PH Fasteners exhibit exceptional toughness and strength properties, tailored by the aging or precipitation temperature applied during the alloy's reinforcement.
                </p>
                <p>
                  SS 15-5 PH Fasteners boast an array of advantages, primarily characterized by their robust martensitic composition. The alloy makeup of SS 15-5 PH includes a notable presence of chromium, nickel, and copper, contributing to its resilience. The precipitation of these core elements, coupled with trace element additions, enhances the strength and durability of the fasteners.
                </p>
                <p>
                  Notably, SS 15-5 PH fasteners excel in corrosion resistance, making them particularly suitable for environments prone to corrosion, such as those near water bodies or saltwater pools. Additionally, their impressive tensile strength renders them indispensable in heavy-duty industrial applications where sturdy connections are vital for operational reliability. The versatility of SS 15-5 PH fasteners extends to achieving a broad range of toughness and strength properties, dependent on the aging or precipitation temperature applied to fortify the alloy.
                </p>
              </div>

              <h3 className="text-2xl font-bold text-gray-900 mb-4 mt-8 border-b border-gray-300 pb-2">
                SS 15-5Ph Chemical Composition
              </h3>
              <p className="text-gray-700 mb-4">Note that this chart includes only some of the most common sizes of SS 15-5Ph Bolt. There are many other sizes available as well, and some applications may require custom sizes or special configurations.</p>
              <div className="overflow-x-auto mb-8">
                <table className="min-w-full border border-gray-300">
                  <thead>
                    <tr className="bg-blue-900 text-white">
                      <th className="px-4 py-3 text-left font-semibold border-r border-gray-300">SS 15-5Ph Elements</th>
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4 mt-8 border-b border-gray-300 pb-2">
                SS 15-5Ph Mechanical Properties
              </h3>
              <div className="overflow-x-auto mb-8">
                <table className="min-w-full border border-gray-300">
                  <tbody>
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4 mt-8 border-b border-gray-300 pb-2">
                Types of SS 15-5Ph Fasteners
              </h3>
              <p className="text-gray-700 mb-6">Each SS 15-5Ph Fasteners have unique design each of them are used in specific applications. Some of them are mentioned below.</p>

              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="border border-gray-200 rounded-lg overflow-hidden">
                  <div className="aspect-square bg-gray-100 flex items-center justify-center">
                    <img src="https://images.pexels.com/photos/209235/pexels-photo-209235.jpeg?auto=compress&cs=tinysrgb&w=400" alt="SS 15-5Ph Nuts" className="w-full h-full object-cover" />
                  </div>
                  <div className="p-4">
                ...
                <div className="border border-gray-200 rounded-lg overflow-hidden">
                  <div className="aspect-square bg-gray-100 flex items-center justify-center">
                    <img src="https://images.pexels.com/photos/209235/pexels-photo-209235.jpeg?auto=compress&cs=tinysrgb&w=400" alt="SS 15-5Ph Bolts" className="w-full h-full object-cover" />
                  </div>
                  <div className="p-4">
                ...
                <div className="border border-gray-200 rounded-lg overflow-hidden">
                  <div className="aspect-square bg-gray-100 flex items-center justify-center">
                    <img src="https://images.pexels.com/photos/209235/pexels-photo-209235.jpeg?auto=compress&cs=tinysrgb&w=400" alt="SS 15-5Ph Washers" className="w-full h-full object-cover" />
                  </div>
                  <div className="p-4">
