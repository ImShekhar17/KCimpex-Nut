        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex gap-8 my-8">
              <img src="https://images.pexels.com/photos/8369648/pexels-photo-8369648.jpeg?auto=compress&cs=tinysrgb&w=120&h=80" alt="Government of India" className="h-16 object-contain grayscale" />
              <img src="https://images.pexels.com/photos/6476589/pexels-photo-6476589.jpeg?auto=compress&cs=tinysrgb&w=120&h=80" alt="ISO Certified" className="h-16 object-contain" />
              <img src="https://images.pexels.com/photos/5650026/pexels-photo-5650026.jpeg?auto=compress&cs=tinysrgb&w=120&h=80" alt="Make in India" className="h-16 object-contain grayscale" />
            </div>

            <button className="bg-[#4a6fa5] text-white px-6 py-3 rounded font-medium hover:bg-[#5a7fb5] transition-colors flex items-center gap-2">
          ...
          <div className="relative">
            <div className="relative">
              ...
              />
              <div className="absolute bottom-4 right-4 bg-gray-800/80 text-white px-6 py-3 rounded font-semibold">
                Bolting Trust
              </div>
            </div>
          </div>
