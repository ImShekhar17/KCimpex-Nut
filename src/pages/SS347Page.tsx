  ...
  const materialCategories = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'SS 347', link: '/materials/ss-347', active: true },
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-6 border-b-2 border-gray-200 pb-4">
                Stainless Steel 347 Fasteners Manufacturer, Supplier of Stainless Steel 347 Bolts, Exporter of Stainless Steel 347 Nuts and Bolts, Leading Stainless Steel 347 Fasteners Manufacturers in India
              </h2>
              <div className="prose max-w-none text-gray-700 leading-relaxed space-y-4 mb-8">
                <p>
                  Stainless Steel 347 and 347H Fasteners are crafted from an austenitic stainless steel alloy comprising chromium, nickel, and columbium (niobium). This alloy is often termed stabilized stainless steel due to heat treatment or stabilization, enhancing its resistance to intergranular corrosion. SS 347 Fasteners find diverse applications across numerous sectors, well-suited for use in industrial settings. Taking reliability a step further, 347H Stainless Steel Fasteners offer superior corrosion resistance, high strength, and a diverse array of shapes and sizes for varied applications. Hence, Stainless Steel 347H Fasteners find ideal use in high-temperature environments such as power plants or oil refineries, where adaptability to intergranular attack renders other stainless steel grades unsuitable.
                </p>
                <p>
                  Stainless Steel 347H Fasteners present a multitude of advantages, primarily their superior corrosion resistance stemming from their stabilized composition. This feature renders them especially well-suited for environments prone to corrosion, including areas near bodies of water or saltwater pools. Furthermore, these fasteners boast remarkable tensile strength, making them indispensable in heavy-duty industrial applications where robust connections are paramount. Their outstanding temperature resistance further enhances their versatility, enabling reliable performance in both hot and cold extremes. In addition to fasteners, our product range extends to include various offerings such as Nickel 201 Nuts, Nickel 200 Washers, and more, ensuring comprehensive solutions to diverse industry requirements.
                </p>
              </div>

              <h3 className="text-2xl font-bold text-gray-900 mb-4 mt-8 border-b border-gray-300 pb-2">
                SS 347 Chemical Composition
              </h3>
              <p className="text-gray-700 mb-4">Note that this chart includes only some of the most common sizes of SS 347 Bolt. There are many other sizes available as well, and some applications may require custom sizes or special configurations.</p>
              <div className="overflow-x-auto mb-8">
                <table className="min-w-full border border-gray-300">
                  <thead>
                    <tr className="bg-blue-900 text-white">
                      <th className="px-4 py-3 text-left font-semibold border-r border-gray-300">SS 347 Elements</th>
                  ...
                  <tbody>
                    <tr className="border-b border-gray-300">
                      ...
                      <td className="px-4 py-3">17 – 20</td>
                    </tr>
                    <tr className="border-b border-gray-300">
                    ...
                    <tr className="border-b border-gray-300">
                      ...
                      <td className="px-4 py-3">62.74 min</td>
                    </tr>
                    <tr className="border-b border-gray-300">
                ...
                <table className="min-w-full border border-gray-300">
                  <tbody>
                    ...
                    <tr className="border-b border-gray-300">
                      ...
                      <td className="px-4 py-3">1454 °C (2650 °F)</td>
                    </tr>
                    <tr className="border-b border-gray-300">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4 mt-8 border-b border-gray-300 pb-2">
                Types of SS 347 Fasteners
              </h3>
              <p className="text-gray-700 mb-6">Each SS 347 Fasteners have unique design each of them are used in specific applications. Some of them are mentioned below.</p>

              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="border border-gray-200 rounded-lg overflow-hidden">
                  <div className="aspect-square bg-gray-100 flex items-center justify-center">
                    <img src="https://images.pexels.com/photos/209235/pexels-photo-209235.jpeg?auto=compress&cs=tinysrgb&w=400" alt="SS 347 Nuts" className="w-full h-full object-cover" />
                  </div>
                  <div className="p-4">
                ...
                <div className="border border-gray-200 rounded-lg overflow-hidden">
                  <div className="aspect-square bg-gray-100 flex items-center justify-center">
                    <img src="https://images.pexels.com/photos/209235/pexels-photo-209235.jpeg?auto=compress&cs=tinysrgb&w=400" alt="SS 347 Bolts" className="w-full h-full object-cover" />
                  </div>
                  <div className="p-4">
                ...
                <div className="border border-gray-200 rounded-lg overflow-hidden">
                  <div className="aspect-square bg-gray-100 flex items-center justify-center">
                    <img src="https://images.pexels.com/photos/209235/pexels-photo-209235.jpeg?auto=compress&cs=tinysrgb&w=400" alt="SS 347 Washers" className="w-full h-full object-cover" />
                  </div>
                  <div className="p-4">
