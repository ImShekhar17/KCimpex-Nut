...
const Inconel625Page = () => {
  ...
  const chemicalComposition = [
    { element: 'Nickel, Ni', content: '58.0 min' },
    { element: 'Silicon, Si', content: '0.50 max' },
    { element: 'Carbon, C', content: '0.10 max' },
    { element: 'Cr', content: '20.0 – 23.0' },
    { element: 'Sulphur, S', content: '0.015max' },
    { element: 'Iron, Fe', content: '5.0 max' },
    { element: 'Manganese, Mn', content: '0.50 max' }
  ];

  const mechanicalProperties = [
    { property: 'Density', value: '8.1 g/cm3' },
    { property: 'Melting Point', value: '1350° C (2460° F)' },
    { property: 'Tensile Strength', value: 'Psi – 135,000 , MPa – 930' },
    { property: 'Yield Strength (0.2%Offset)', value: 'Psi – 75,000 , MPa – 517' },
    { property: 'Elongation', value: '42.5 %' }
  ];
  ...
  const materialCategories = [
    {
      ...
      items: [
        ...
        { name: 'INCONEL alloy 625', link: '/materials/inconel-alloy-625', active: true },
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                Inconel Fasteners Manufacturer, Supplier of Inconel 625 Bolts, Exporter of Inconel 625 Nuts and Bolts, Leading Inconel 625 Fasteners Manufacturers in India
              </h2>
              <div className="space-y-4 text-gray-700 leading-relaxed">
                <p>
                  <span className="text-[#1e3a8a] font-semibold">UNS N 06625 Inconel 625 Fasteners</span> derive from a nickel-chromium alloy fortified with molybdenum and niobium, meticulously crafted to endure even the most extreme conditions. Frequently employed for essential components like bolts, screws, nuts, washers, and pins, it boasts remarkable corrosion resistance in both acidic and alkaline environments. Additionally, Inconel 625 Fasteners exhibit exceptional oxidation resistance at elevated temperatures, capable of withstanding up to 2200°F. These attributes render it particularly invaluable in manufacturing processes necessitating frequent exposure to high-temperature or environments containing multiple types of acids such as seawater.
                </p>
                <p>
                  The primary advantage of utilizing <span className="text-[#1e3a8a] font-semibold">Inconel 625 Industrial Fasteners</span> lies in their unparalleled strength and resilience. They possess the ability to withstand extraordinarily high pressures without experiencing deformation or deterioration, a trait that sets them apart from other materials. Beyond this, they possess the capacity to endure harsh conditions. This quality makes them indispensable for applications demanding outstanding component integrity even after prolonged exposure to intense heat or pressure. Moreover, these fasteners necessitate minimal maintenance or upkeep as they are frequently utilized in specific applications demanding robust performance over time. Furthermore, these fasteners do not necessitate any treatment before use in applications. In addition to fasteners, our product range encompasses other offerings such as Stainless Steel 317L Fasteners, Monel 400 Fasteners, and more.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
              ...
              <p className="text-gray-700 mb-6">
                Standard INCONEL 625 Fasteners specifications as per Fasteners manufacturers.
              </p>
              <table className="w-full border border-gray-300">
                <tbody>
                  <tr className="border-b border-gray-300">
                    <td className="px-6 py-3 bg-gray-50 font-semibold text-gray-900">Material</td>
                    <td className="px-6 py-3 text-gray-700">Inconel 625</td>
                  </tr>
                  <tr className="border-b border-gray-300">
            ...
            <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
              ...
              <p className="text-gray-700 mb-8">
                Each <span className="text-[#1e3a8a] font-semibold">INCONEL 625</span> Fasteners have unique design each of them are used in specific applications. Some of them are mentioned below.
              </p>
            ...
            <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
              ...
              <p className="text-gray-700 mb-6">
                Note that this chart includes only some of the most common sizes of <span className="text-[#1e3a8a] font-semibold">INCONEL 625 Bolt</span>. There are many other sizes available as well, and some applications may require custom sizes or special configurations.
              </p>
              <div className="overflow-x-auto">
                <table className="w-full border border-gray-300">
                  <thead>
                    <tr className="bg-[#1e3a8a] text-white">
                      <th className="px-6 py-3 text-left font-semibold">INCONEL 625 Fasteners</th>
