  ...
  const materialCategories = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'SS 310', link: '/materials/ss-310', active: true },
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-6 border-b-2 border-gray-200 pb-4">
                Stainless Steel 310 Fasteners Manufacturer, Supplier of Stainless Steel 310 Bolts, Exporter of Stainless Steel 310 Nuts and Bolts, Leading Stainless Steel 310 Fasteners Manufacturers in India
              </h2>
              <div className="prose max-w-none text-gray-700 leading-relaxed space-y-4 mb-8">
                <p>
                  Stainless Steel 310 Fasteners are crafted from a high-grade alloy known for its exceptional heat resistance, comprising 25% chromium and 20% nickel. Stainless Steel 310 Fasteners boast high strength and resilience. This grade incorporates chromium, nickel, and manganese to enhance mechanical properties and overall product performance. Stainless Steel 310 Fasteners find widespread use in applications requiring resistance to elevated temperatures, making them suitable for various environments prone to thermal cycling. Industries such as chemical processing, piping systems, heat exchangers, nuclear reactors, oil & gas production equipment, and offshore drilling platforms commonly rely on Stainless Steel 310 Fasteners for their reliability and performance in demanding conditions.
                </p>
                <p>
                  Stainless Steel 310 grade, renowned for its superb resistance to oxidation and corrosion, proves to be an ideal choice for demanding environments. SS 310 Fasteners are widely utilized in various applications requiring resistance to high temperatures and corrosive elements. Commonly found in chemical and petrochemical processing equipment, heat exchangers, and similar industrial settings, SS 310 Fasteners excel in harsh conditions. Similar to SS 317L Fasteners, SS 310 Fasteners are available in diverse types and sizes, including bolts, nuts, screws, washers, and studs, catering to a wide range of industrial needs.
                </p>
              </div>

              <h3 className="text-2xl font-bold text-gray-900 mb-4 mt-8 border-b border-gray-300 pb-2">
                Specifications of SS 310
              </h3>
              <p className="text-gray-700 mb-4">Standard SS 310 Fasteners specifications as per Fasteners manufacturers.</p>
              <div className="overflow-x-auto mb-8">
                <table className="min-w-full border border-gray-300">
                  <tbody>
                    <tr className="border-b border-gray-300">
                      <td className="px-4 py-3 font-semibold bg-gray-100 border-r border-gray-300">Material</td>
                      <td className="px-4 py-3">Stainless Steel 310</td>
                    </tr>
                    <tr className="border-b border-gray-300">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4 mt-8 border-b border-gray-300 pb-2">
                Types of SS 310 Fasteners
              </h3>
              <p className="text-gray-700 mb-6">Each SS 310 Fasteners have unique design each of them are used in specific applications. Some of them are mentioned below.</p>

              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="border border-gray-200 rounded-lg overflow-hidden">
                  <div className="aspect-square bg-gray-100 flex items-center justify-center">
                    <img src="https://images.pexels.com/photos/209235/pexels-photo-209235.jpeg?auto=compress&cs=tinysrgb&w=400" alt="SS 310 Nuts" className="w-full h-full object-cover" />
                  </div>
                  <div className="p-4">
                ...
                <div className="border border-gray-200 rounded-lg overflow-hidden">
                  <div className="aspect-square bg-gray-100 flex items-center justify-center">
                    <img src="https://images.pexels.com/photos/209235/pexels-photo-209235.jpeg?auto=compress&cs=tinysrgb&w=400" alt="SS 310 Bolts" className="w-full h-full object-cover" />
                  </div>
                  <div className="p-4">
                ...
                <div className="border border-gray-200 rounded-lg overflow-hidden">
                  <div className="aspect-square bg-gray-100 flex items-center justify-center">
                    <img src="https://images.pexels.com/photos/209235/pexels-photo-209235.jpeg?auto=compress&cs=tinysrgb&w=400" alt="SS 310 Washers" className="w-full h-full object-cover" />
                  </div>
                  <div className="p-4">
              ...
              <p className="text-gray-700 mb-4">Note that this chart includes only some of the most common sizes of SS 310 Bolt. There are many other sizes available as well, and some applications may require custom sizes or special configurations.</p>
              <div className="overflow-x-auto mb-8">
                <table className="min-w-full border border-gray-300">
                  <thead>
                    <tr className="bg-[#4a5f8f] text-white">
                      <th className="px-4 py-3 text-left font-semibold border-r border-gray-300">SS 310 Fasteners</th>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-8">
                ...
                <div className="flex items-center justify-center">
                  <img src="https://images.pexels.com/photos/257700/pexels-photo-257700.jpeg?auto=compress&cs=tinysrgb&w=600" alt="SS 310 Applications" className="rounded-lg shadow-md w-full" />
                </div>
              </div>
            </div>
          </div>
