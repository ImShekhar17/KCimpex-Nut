...
const Inconel600Page = () => {
  ...
  const chemicalComposition = [
    { element: 'Nickel, Ni', content: '72.0 min' },
    { element: 'Silicon, Si', content: '.50 max' },
    { element: 'Carbon, C', content: '.15 max' },
    { element: 'Sulphur, S', content: '.015 max' },
    { element: 'Copper, Cu', content: '.50 max' },
    { element: 'Iron, Fe', content: '6.0-10.0' },
    { element: 'Manganese, Mn', content: '1.00 max' }
  ];

  const mechanicalProperties = [
    { property: 'Density', value: '8.47 g/cm3' },
    { property: 'Melting Point', value: '1413° C (2580° F)' },
    { property: 'Tensile Strength', value: 'Psi – 95,000 , MPa – 655' },
    { property: 'Yield Strength (0.2%Offset)', value: 'Psi – 45,000 , MPa – 310' },
    { property: 'Elongation', value: '40 %' }
  ];
  ...
  const materialCategories = [
    {
      ...
      items: [
        { name: 'INCONEL 600', link: '/materials/inconel-600', active: true },
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                Inconel Fasteners Manufacturer, Supplier of Inconel 600 Bolts, Exporter of Inconel 600 Nuts and Bolts, Leading Inconel 600 Fasteners Manufacturers in India
              </h2>
              <div className="space-y-4 text-gray-700 leading-relaxed">
                <p>
                  <span className="text-[#1e3a8a] font-semibold">Inconel 600</span> Fasteners are a high-performance alloy nut crafted from a blend of nickel, chromium, and iron, meticulously engineered to withstand oxidation even under extreme temperatures. Renowned for their corrosion resistance and exceptional mechanical attributes like strength and ductility, Inconel 600 Hex Fasteners are ideal for demanding applications that demand fasteners with top-tier corrosion protection.
                </p>
                <p>
                  <span className="text-[#1e3a8a] font-semibold">Inconel 600</span> machine fasteners offer unparalleled corrosion protection compared to alternative alloys, owing to their distinctive composition comprising nickel, chromium, and iron. Inconel 600 fasteners exceptional mechanical characteristics like strength and ductility, rendering them apt for diverse applications spanning automotive and aerospace components, as well as environments subjected to severe temperatures or harsh conditions such as offshore oil rigs or chemical plants. Their robustness, combined with their corrosion resistance, positions them as the prime choice for those seeking dependable fasteners capable of enduring the most challenging conditions imaginable.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
              ...
              <p className="text-gray-700 mb-6">
                Standard INCONEL 600 Fasteners specifications as per Fasteners manufacturers.
              </p>
              <table className="w-full border border-gray-300">
                <tbody>
                  <tr className="border-b border-gray-300">
                    <td className="px-6 py-3 bg-gray-50 font-semibold text-gray-900">Material</td>
                    <td className="px-6 py-3 text-gray-700">Inconel Alloy 600</td>
                  </tr>
                  <tr className="border-b border-gray-300">
            ...
            <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
              ...
              <p className="text-gray-700 mb-8">
                Each <span className="text-[#1e3a8a] font-semibold">INCONEL 600</span> Fasteners have unique design each of them are used in specific applications. Some of them are mentioned below.
              </p>
            ...
            <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
              ...
              <p className="text-gray-700 mb-6">
                Note that this chart includes only some of the most common sizes of <span className="text-[#1e3a8a] font-semibold">INCONEL 600 Bolt</span>. There are many other sizes available as well, and some applications may require custom sizes or special configurations.
              </p>
              <div className="overflow-x-auto">
                <table className="w-full border border-gray-300">
                  <thead>
                    <tr className="bg-[#1e3a8a] text-white">
                      <th className="px-6 py-3 text-left font-semibold">INCONEL 600 Fasteners</th>
