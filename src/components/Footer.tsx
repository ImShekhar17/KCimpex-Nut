        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          <div>
            ...
            <p className="text-gray-300 text-sm leading-relaxed mb-6">
              K. C. Impex: Your top source for high-quality fittings, fasteners, nuts, bolts, and washers in high-performance alloys. With a decade of expertise, we deliver excellence, reliability, and prompt service to meet your engineering needs.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {productLinks.map((link, index) => (
                <li key={index}>
                  <a href="#" className="text-gray-300 hover:text-white text-sm flex items-center gap-2">
            ...
            <form className="mb-6">
              <div className="flex">
                <input
                  ...
                  className="flex-1 px-4 py-2 bg-white/10 border border-white/20 rounded-l text-sm focus:outline-none focus:ring-2 focus:ring-[#1e3a8a]"
                />
                <button
                  type="submit"
                  className="bg-[#1e3a8a] text-white px-4 py-2 rounded-r hover:bg-[#1e4cb8] transition-colors"
                >
                  Subscribe
                </button>
              </div>
