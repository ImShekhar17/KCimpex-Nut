  ...
  const materialCategories = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'HASTELLOY C22', link: '/materials/hastelloy-c22', active: true },
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-6 border-b-2 border-gray-200 pb-4">
                Hastelloy C22 Fasteners Manufacturer, Supplier of Hastelloy C22 Bolts, Exporter of Hastelloy C22 Nuts and Bolts, Leading Hastelloy C22 Fasteners Manufacturers in India
              </h2>
              <div className="prose max-w-none text-gray-700 leading-relaxed space-y-4 mb-8">
                <p>
                  Hastelloy C22 Fasteners are engineered from a nickel-chromium-molybdenum-tungsten alloy with enhanced resistance to pitting, crevice corrosion, and stress corrosion cracking. This alloy offers exceptional performance in oxidizing and reducing environments, making it superior to many other nickel alloys. ASTM B574 UNS N06022 Fasteners demonstrate outstanding resistance to both oxidizing and reducing media, making them ideal for applications in chemical processing, pollution control, and waste treatment industries. The alloy's versatility extends to chloride-induced stress corrosion cracking resistance, making it a reliable choice for harsh chemical environments.
                </p>
                <p>
                  Hastelloy C22 Fasteners provide exceptional reliability in aggressive chemical environments. With superior resistance to both oxidizing and reducing conditions, these fasteners excel where other materials fail. Available in various forms such as Hastelloy C22 Nuts, Hastelloy C22 Bolts, and specialty fasteners, they meet the demanding requirements of chemical processing plants, pharmaceutical manufacturing, and environmental applications. The alloy's outstanding weldability and fabricability make it an economical choice for complex industrial applications requiring long-term durability and performance.
                </p>
              </div>

              <h3 className="text-2xl font-bold text-gray-900 mb-4 mt-8 border-b border-gray-300 pb-2">
                Specifications of HASTELLOY C22
              </h3>
              <p className="text-gray-700 mb-4">Standard HASTELLOY C22 Fasteners specifications as per Fasteners manufacturers.</p>
              <div className="overflow-x-auto mb-8">
                <table className="min-w-full border border-gray-300">
                  <tbody>
                    <tr className="border-b border-gray-300">
                      <td className="px-4 py-3 font-semibold bg-gray-100 border-r border-gray-300">Material</td>
                      <td className="px-4 py-3">Hastelloy C22</td>
                    </tr>
                    <tr className="border-b border-gray-300">
              ...
              <p className="text-gray-700 mb-6">Each HASTELLOY C22 Fasteners have unique design each of them are used in specific applications. Some of them are mentioned below.</p>

              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="border border-gray-200 rounded-lg overflow-hidden">
                  <div className="aspect-square bg-gray-100 flex items-center justify-center">
                    <img src="https://images.pexels.com/photos/209235/pexels-photo-209235.jpeg?auto=compress&cs=tinysrgb&w=400" alt="Hastelloy C22 Nuts" className="w-full h-full object-cover" />
                  </div>
                  <div className="p-4">
                ...
                <div className="border border-gray-200 rounded-lg overflow-hidden">
                  <div className="aspect-square bg-gray-100 flex items-center justify-center">
                    <img src="https://images.pexels.com/photos/209235/pexels-photo-209235.jpeg?auto=compress&cs=tinysrgb&w=400" alt="Hastelloy C22 Bolts" className="w-full h-full object-cover" />
                  </div>
                  <div className="p-4">
                ...
                <div className="border border-gray-200 rounded-lg overflow-hidden">
                  <div className="aspect-square bg-gray-100 flex items-center justify-center">
                    <img src="https://images.pexels.com/photos/209235/pexels-photo-209235.jpeg?auto=compress&cs=tinysrgb&w=400" alt="Hastelloy C22 Washers" className="w-full h-full object-cover" />
                  </div>
                  <div className="p-4">
              ...
              <p className="text-gray-700 mb-4">Note that this chart includes only some of the most common sizes of HASTELLOY C22 Bolt. There are many other sizes available as well, and some applications may require custom sizes or special configurations.</p>
              <div className="overflow-x-auto mb-8">
                <table className="min-w-full border border-gray-300">
                  <thead>
                    <tr className="bg-blue-900 text-white">
                      <th className="px-4 py-3 text-left font-semibold border-r border-gray-300">HASTELLOY C22 Elements</th>
                  ...
                  <tbody>
                    ...
                    <tr className="border-b border-gray-300">
                      ...
                      <td className="px-4 py-3">0.50 max%</td>
                    </tr>
                    <tr className="border-b border-gray-300">
...
export default HasteloyC22Page;
